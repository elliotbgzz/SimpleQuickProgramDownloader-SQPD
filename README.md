...
2. Right click and execute Terminal from the folder you have the script in.
3. Run the following command: powershell -ExecutionPolicy Bypass -File .\install_apps.ps1
